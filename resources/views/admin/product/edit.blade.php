            ...
            <form method="post" action="{{route('update.product')}}" >
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <textarea name="short_desc_en" id="textarea" class="form-control" required placeholder="Textarea text">
                                    {!! $products->short_desc_en !!}</textarea>     
                                        </div>
                                    </div>
                                ...
                                <textarea name="short_desc_hin" id="textarea" class="form-control" required placeholder="Textarea text">
                                    {!! $products->short_desc_hin !!}</textarea>     
                                        </div>
                                    </div>
            ...
            <div class="col-md-12">
                        ...
                        <form method="post" action="{{route('update.product.image')}}" enctype="multipart/form-data">
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="card-body">
                                <h5 class="card-title">
                                    <a href="{{ route('product.multiimg.delete',$img->id) }}" onclick="return confirm('are you sure want to delete?')" class="btn btn-sm btn-danger" id="delete" title="Delete Data"><i class="fa fa-trash"></i> </a>
                                    </h5>
                                <p class="card-text"> 
                                    <div class="form-group">
...
<div class="col-md-12">
       ...
       <form method="post" action="{{ route('update.product.thumb.image') }}" enctype="multipart/form-data">
       @csrf
