  ...
  <!-- Content Wrapper. Contains page content -->
	 ...
	 <tr>
		...
		<td width="25%">
            ...
            <a href="{{ route('coupon.delete',$item->id) }}" class="btn btn-danger" onclick="return confirm('are you sure want to delete?')" title="Delete Data" id="delete">
...
<!--   ------------ Add Cupon Page -------- -->
          ...
          <div class="col-4">
            ...
            <form method="post" action="{{ route('coupon.store') }}" >
                ...
                <input type="submit" class="btn btn-rounded btn-primary mb-5 mt-3" value="Add New">					 
                </div>
		</form>
